...
use App\Filament\Resources\Agendas\RelationManagers\PresensisRelationManager;
...
class AgendaResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Daftar Agenda';
    ...
    {
        return [
            PresensisRelationManager::class,
        ];
    }

    public static function canViewAny(): bool
    {
        return (auth()->user()?->hasAnyRole(['sekretaris', 'super_admin']) ?? false);
    }
