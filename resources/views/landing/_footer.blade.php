...
<footer class="bg-white relative overflow-hidden border-t border-hairline">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        [
            'Instagram',
            'https://www.instagram.com/ukmmci_unamin/',
        ...
        ['YouTube', 'https://www.youtube.com/watch?v=xcStDzVK-Z8', 'M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z'],
    ] as [$name, $url, $path])
            ...
            <div>
                ...
                <ul class="space-y-4">
                    @foreach ([['fa-regular fa-envelope', 'ukmmediakreatifinformation@gmail.com'], ['fa-solid fa-mobile-screen', '+62 812-3456-7890'], ['fa-solid fa-location-dot', 'Lab Perangkat Keras, UNAMIN'], ['fa-regular fa-clock', 'Jumat, 14:00 - 16:00 WIT']] as [$iconClass, $text])
                        <li class="flex items-start gap-2.5">
                            <i class="{{ $iconClass }} text-ink-mute mt-0.5 w-4 text-center shrink-0"></i>
                            <span class="text-ink-mute text-sm leading-relaxed"
                                style="font-weight:300;">{{ $text }}</span>
                        </li>
                    @endforeach
                </ul>
            </div>
        ...
        <div class="py-6 border-t border-hairline flex flex-col sm:flex-row items-center justify-between gap-3">
            <p class="text-ink-mute text-xs"
                ...
                © {{ date('Y') }} UKM MCI. Dibuat dengan <i class="fa-solid fa-heart text-ruby mx-0.5"></i> oleh
                Haris Aja.
            </p>
