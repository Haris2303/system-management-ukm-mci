...
<footer class="bg-slate-900 text-white relative overflow-hidden">
    {{-- Top decoration --}}
    <div class="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-500 to-transparent"></div>
    <div class="absolute -top-40 -right-40 w-96 h-96 bg-brand-600/10 rounded-full blur-3xl pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="py-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-500 to-brand-400 flex items-center justify-center shadow-lg shadow-brand-900">
                        <span class="text-white font-display font-bold">M</span>
                    </div>
                    <div>
                        <div class="font-display font-bold text-xl">UKM MCI</div>
                        <div class="text-slate-400 text-xs">Mahasiswa Creative & Innovation</div>
                    </div>
                </div>
        ...
        ['LinkedIn', '#', 'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z'],
                        ...
                        <a href="{{ $url }}" target="_blank" aria-label="{{ $name }}"
                            class="w-9 h-9 rounded-lg bg-slate-800 hover:bg-brand-600 flex items-center justify-center transition-all duration-200 hover:scale-110">
            ...
            {{-- Quick links --}}
            <div>
                <div class="font-display font-bold text-sm mb-5 text-white">Navigasi</div>
                <ul class="space-y-3">
                    @foreach ([['#tentang', 'Tentang Kami'], ['#program', 'Program & Divisi'], ['#galeri', 'Galeri Kegiatan'], ['#pengurus', 'Struktur Pengurus'], ['#daftar', 'Daftar Anggota']] as [$href, $label])
                        <li>
                            <a href="{{ $href }}"
                                class="text-slate-400 text-sm hover:text-brand-400 transition-colors font-light">
                                {{ $label }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div class="py-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-1">
                ...
                <span class="text-slate-500 text-xs">Sistem berjalan normal</span>
            </div>
        </div>
    </div>
</footer>
