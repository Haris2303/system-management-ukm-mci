    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-18">
                ...
                <div class="hidden lg:flex items-center gap-1">
                    @foreach ([['/#tentang', 'Tentang'], ['/#divisi', 'Divisi'], ['/berita', 'Berita', 'berita'], ['/galeri', 'Galeri', 'galeri'], ['/pengurus', 'Pengurus']] as [$href, $label])
                        <a href="{{ $href }}"
        ...
        <div id="mobile-menu" class="lg:hidden navbar-glass border-t border-hairline">
            <div class="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-1">
                @foreach ([['/#tentang', 'Tentang Kami'], ['/#divisi', 'Divisi'], ['/galeri', 'Galeri'], ['/pengurus', 'Pengurus']] as [$href, $label])
                    <a href="{{ $href }}"
