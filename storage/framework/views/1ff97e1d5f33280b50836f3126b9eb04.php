...
<div style="display:flex; flex-direction:column; gap:16px; padding:4px 0;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
        <div style="background:<?php echo e($isReady ? '#f0fdf4' : '#eff6ff'); ?>; border:1px solid <?php echo e($isReady ? '#86efac' : '#bfdbfe'); ?>; border-radius:10px; padding:16px; text-align:center;">
            <p style="font-size:30px; font-weight:700; color:<?php echo e($isReady ? '#16a34a' : '#1d4ed8'); ?>; margin:0;"><?php echo e($chunksSelesai); ?></p>
            <p style="font-size:11px; color:<?php echo e($isReady ? '#16a34a' : '#3b82f6'); ?>; margin:4px 0 0;">
                <?php echo e($isReady ? 'Total chunk berhasil' : 'Chunks berhasil diproses'); ?>
        ...
        <div style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:10px; padding:16px; text-align:center;">
            <p style="font-size:30px; font-weight:700; color:#6b7280; margin:0;">
                <?php echo e($recentChunks->isNotEmpty() ? $recentChunks->first()->chunk_index : '—'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentChunks->isNotEmpty()): ?>
        <div>
            ...
            <div style="display:flex; flex-direction:column; gap:8px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:8px; padding:10px 12px;">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
                            <span style="font-size:12px; font-weight:600; color:#374151;">Chunk #<?php echo e($chunk->chunk_index); ?></span>
                            <span style="font-size:11px; color:#9ca3af; background:#e5e7eb; padding:2px 8px; border-radius:999px;"><?php echo e($chunk->token_count); ?> token</span>
                        </div>
                        <p style="font-size:12px; color:#6b7280; margin:0; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                            <?php echo e($chunk->content); ?>
...
<?php /**PATH C:\laragon\www\ukm-mci-digitalisasi\resources\views/filament/modals/chunk-progress.blade.php ENDPATH**/ ?>