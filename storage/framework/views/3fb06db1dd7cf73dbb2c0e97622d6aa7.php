        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($openRecruitment): ?>
                    <div class="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-brand-200 border border-brand-300/40 text-brand-700 text-xs animate-fade-in"
                        ...
                        <?php echo e($openRecruitment->judul); ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($openRecruitment->gelombang): ?>
                            · <?php echo e($openRecruitment->gelombang); ?>
                ...
                <div class="flex items-center gap-8 pt-2" style="animation: fadeUp 0.8s 0.35s ease both;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['200+', 'Anggota Aktif'], ['50+', 'Project Selesai'], ['8', 'Divisi']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$n, $l]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="text-center">
                            <div class="font-display text-2xl text-brand-600"
                                style="font-weight:300; font-feature-settings:'tnum'; letter-spacing:-0.42px;">
                                <?php echo e($n); ?></div>
                            <div class="text-xs text-ink-mute mt-0.5" style="font-weight:400;"><?php echo e($l); ?></div>
                        </div>
            ...
            <div class="hidden lg:flex justify-center items-center relative"
                ...
                <div class="relative animate-float -translate-y-10">
                    ...
                    <img src="<?php echo e(asset('assets/logo/logo.png')); ?>" alt="UKM MCI Logo"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $divisis->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $i = $loop->index; ?>
                        <div class="<?php echo e($badgePositions[$i]); ?> bg-white rounded-xl shadow-xl shadow-brand-100 px-4 py-3 flex items-center gap-2.5 border border-hairline"
                            style="animation: fadeIn 0.6s <?php echo e(0.4 + $i * 0.15); ?>s ease both;">
                            <div class="w-8 h-8 rounded-lg <?php echo e($badgeColors[$i]['bg']); ?> flex items-center justify-center shrink-0"
                                style="color: <?php echo e($badgeColors[$i]['color']); ?>;">
                                <i class="<?php echo e($divisi->icon); ?> fa-sm"></i>
                            </div>
                            <div>
                                <div class="text-xs text-ink whitespace-nowrap" style="font-weight:400;">
                                    <?php echo e($divisi->nama); ?></div>
...
<?php /**PATH C:\laragon\www\ukm-mci-digitalisasi\resources\views/landing/_hero.blade.php ENDPATH**/ ?>