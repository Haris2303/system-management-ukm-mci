    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleries->isNotEmpty()): ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="gallery-item reveal reveal-delay-<?php echo e(min(($loop->index % 4) + 1, 4)); ?> rounded-2xl overflow-hidden
                        <?php echo e($loop->first ? 'md:col-span-2 md:row-span-2' : ''); ?>

                        <?php echo e($loop->index === 3 ? 'md:col-span-2' : ''); ?> relative group cursor-pointer"
                        onclick="openLightbox('<?php echo e(asset('storage/' . $item->foto)); ?>', '<?php echo e($item->judul); ?>')">
                        <img src="<?php echo e(asset('storage/' . $item->foto)); ?>" alt="<?php echo e($item->judul); ?>"
                            class="w-full h-full object-cover <?php echo e($loop->first ? 'min-h-[320px]' : 'min-h-[180px]'); ?>">
                        <div
                            ...
                            <div>
                                <div class="text-[10px] font-bold text-brand-300 uppercase tracking-widest">
                                    <?php echo e($item->kategori); ?></div>
                                <div class="text-white font-semibold text-sm mt-0.5"><?php echo e($item->judul); ?></div>
                            </div>
                        </div>
                    </div>
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $placeholders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$judul, $kategori, $big, $grad, $iconClass]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div
                        class="gallery-item reveal reveal-delay-<?php echo e(min(($loop->index % 4) + 1, 4)); ?> rounded-2xl overflow-hidden
                        <?php echo e($big ? 'md:col-span-2 md:row-span-2' : ''); ?>

                        relative group cursor-pointer">
                        <div
                            class="w-full bg-gradient-to-br <?php echo e($grad); ?> flex items-center justify-center
                            <?php echo e($big ? 'min-h-[320px]' : 'min-h-[180px]'); ?> relative">
                            <div class="text-center text-white">
                                <div class="text-5xl mb-3"><i class="<?php echo e($iconClass); ?>"></i></div>
                                <div class="font-display font-bold text-lg"><?php echo e($judul); ?></div>
                                <div class="text-xs opacity-70 mt-1"><?php echo e($kategori); ?></div>
                            </div>
                            <div
...
<?php /**PATH C:\laragon\www\ukm-mci-digitalisasi\resources\views/landing/_gallery.blade.php ENDPATH**/ ?>